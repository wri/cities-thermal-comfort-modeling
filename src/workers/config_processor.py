...
def parse_scenario_config(yml_values):
    try:
        ...
        scenario_id = str(unpack_quoted_value(scenario['scenario_id'])).lower()
    ...
    return scenario_id, infra_id, description, author, publishing_target
...
def parse_method_attributes_config(yml_values):
    ...
    return (processing_method, northern_leaf_start, northern_leaf_end, southern_leaf_start, southern_leaf_end, wall_lower_limit_height,
            ...
            emis_walls, emis_ground, output_tmrt, output_sh, output_utci, sampling_local_hours, use_airt_file)
