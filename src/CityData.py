...
SOURCE_DATA_SUBFOLDER = "source_data"
SOURCE_MET_SUBFOLDER = "met_files"
SOURCE_DATA_MAP = "primary_data_sources.yml"
...
class CityData:
    def __init__(self, city_source_path, city_target_path,
        ...
        self.city_source_path = city_source_path
        self.city_target_path = city_target_path
        ...
        self.data_source_path = os.path.join(city_source_path, SOURCE_DATA_SUBFOLDER)
        self.met_files_path = os.path.join(city_source_path, SOURCE_MET_SUBFOLDER)
        self.preprocessed_data_path = os.path.join(city_target_path, GENERATED_PREPROCESSED_SUBFOLDER)
        self.tcm_results_path = os.path.join(city_target_path, GENERATED_TCM_SUBFOLDER)
        ...
        self.veg_canopy_path = os.path.join(self.data_source_path, self.veg_canopy_file)
        self.landcover_path = os.path.join(self.data_source_path, self.landcover_file)

        self.wall_height_path = os.path.join(self.preprocessed_data_path, self.wall_height_file)
        self.wall_aspect_path = os.path.join(self.preprocessed_data_path, self.wall_aspect_file)
        self.svfs_zip_path = os.path.join(self.preprocessed_data_path, self.svfs_zip_file)

def instantiate_city_data(city_folder_name, source_base_path, target_base_path):
    city_source_path = str(os.path.join(source_base_path, city_folder_name))
    city_target_path = str(os.path.join(target_base_path, city_folder_name))
    ...
    city_data = CityData(city_source_path, city_target_path,
                         dem_file, dsm_file, veg_canopy_file, landcover_file,
