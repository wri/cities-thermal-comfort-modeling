...
def log_method_failure(start_time, feature, step, source_base_path, e_msg, logger):
    ...
    if step is None:
        ...
        logger.error(f"**** FAILED execution of '{feature}' fpr met_series:{step} after runtime:{runtime} mins\tconfig:'{source_base_path}'({e_msg})")
