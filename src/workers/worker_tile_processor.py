...
def process_tile(city_json_str, processing_method, source_base_path, target_base_path, city_folder_name, tile_folder_name,
    ...
    create_folder(tiled_city_data.target_tile_path)
    create_folder(tiled_city_data.target_raster_files_path)
    create_folder(tiled_city_data.target_intermediate_data_path)
    create_folder(tiled_city_data.target_tcm_results_path)
    ...
    def _execute_mrt_method(step_index, processing_method, folder_city, folder_tile, source_path, target_path, met_names, offset_utc):
        ...
        for met_filename in met_names:
            ...
            tile_output_path = os.path.join(target_tcm_results_path, file_stem)
